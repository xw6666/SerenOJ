...
const rootState = {
  ...
  websiteConfig:{
    ...
    shortName:'SerenOJ',
    projectName:'SerenOJ',
    description:'一个精简的单体在线判题系统',
    recordName:'',
    recordUrl:'#',
    projectUrl:'#',
    register: true,
    openPublicDiscussion: false,
    openGroupDiscussion: false,
    openContestComment: false
  },
  registerTimeOut: 60,
  resetTimeOut: 90,
...
const rootActions = {
  ...
  getWebsiteConfig ({commit, state}) {
    return Promise.resolve(state.websiteConfig)
  },
}
